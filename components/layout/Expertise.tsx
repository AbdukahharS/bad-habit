  ...
  en: [
    {
      ...
      highlight: 'Software',
      description:
        'Strong foundation in functional and OOP paradigms. Proficient in JavaScript, TypeScript, and software architecture for scalable systems.',
    ...
    },
    {
      ...
      description:
        '5 years building production-grade interfaces with React, Next.js, Vue, Nuxt, Astro, and TanStack. From complex dashboards and interactive mapping apps to cross-platform mobile experiences.',
    ...
    },
    {
      ...
      description:
        'Backend with Node.js, Bun, Express.js, NestJS, and Elysia. PostgreSQL, Prisma, Drizzle ORM. Cross-platform desktop apps with Electron.js and Tauri, plus mobile with Flutter.',
  ...
  uz: [
    {
      ...
      highlight: 'Dasturiy',
      description:
        'Funksional va OOP paradigmalarda mustahkam bilim. JavaScript, TypeScript va masshtablanuvchi tizimlar arxitekturasida tajriba.',
      gradient: 'from-pink-500 to-rose-500',
      bgGradient:
        'linear-gradient(135deg, rgba(236, 72, 153, 0.1) 0%, rgba(244, 63, 94, 0.1) 100%)',
    },
    {
      ...
      subtitle: 'React, NextJS',
      description:
        'React, Next.js, Vue, Nuxt, Astro va TanStack bilan 5 yillik production-darajadagi interfeyslar yaratish tajribasi. Murakkab dashboardlar, interaktiv xarita ilovalari va kross-platforma mobil tajribalar.',
      gradient: 'from-blue-500 to-cyan-500',
      bgGradient:
        'linear-gradient(135deg, rgba(59, 130, 246, 0.1) 0%, rgba(6, 182, 212, 0.1) 100%)',
    },
    {
      ...
      highlight: 'NodeJS',
      description:
        'Node.js, Bun, Express.js, NestJS va Elysia bilan backend. PostgreSQL, Prisma, Drizzle ORM. Electron.js va Tauri yordamida desktop, Flutter bilan mobil ilovalar yaratish.',
      gradient: 'from-green-500 to-emerald-500',
      bgGradient:
        'linear-gradient(135deg, rgba(34, 197, 94, 0.1) 0%, rgba(16, 185, 129, 0.1) 100%)',
    },
      ...
      <section className='px-6 md:px-12 xl:px-24 py-16 md:py-24' id='expertise'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto gap-6 lg:gap-0'>
            ...
            >
              <div
                className={`relative px-6 py-8 backdrop-blur-sm transition-all duration-500 hover:scale-[1.02] border-4 h-full ${
                  index === 0
                    ? 'border-slate-300 md:border-r-transparent'
                    : index === 1
                      ? 'border-slate-300 lg:border-r-transparent'
              ...
              >
                ...
                <div className='flex items-center gap-5 mb-4'>
                  <div
                    className={`p-3 rounded-xl bg-linear-to-r ${area.gradient} bg-opacity-20 border border-white/20 backdrop-blur-sm group-hover:scale-110 transition-transform duration-300`}
                  >
                  ...
                  <h3 className='text-2xl font-bold text-white font-poppins group-hover:text-blue-300 transition-colors duration-300'>
                    <span
                      className={`relative inline-block after:block after:absolute after:w-[calc(100%+4px)] after:h-2 after:bottom-1 after:-left-0.5 after:z-[-1] after:transition-all after:bg-linear-to-r ${area.gradient} after:opacity-80 hover:after:opacity-100`}
                    >
                      {area.highlight}
                    </span>
                    {area.title !== area.highlight && (
                      <span className='text-gray-300'>
                        {' '}
                        {area.title.replace(area.highlight, '')}
                      </span>
                    )}
                    {area.subtitle && (
                      <div className='text-gray-400 font-medium text-base mt-1'>
                        {area.subtitle}
                      </div>
                    )}
                  </h3>
                ...
                <div
                  className={`absolute inset-0 bg-linear-to-r ${area.gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-300 pointer-events-none`}
                ></div>
              </div>
            </div>
          ))}
          ...
          <div className='p-6 justify-center items-center hidden md:flex lg:hidden relative'>
            <div
              className='relative p-6 rounded-2xl border border-white/10 backdrop-blur-sm group hover:border-purple-400/30 transition-all duration-500'
              style={{
                background:
        ...
        <div className='mt-16 max-w-4xl mx-auto hidden'>
          <div
            className='relative p-8 rounded-2xl border border-white/10 backdrop-blur-sm group hover:border-purple-400/30 transition-all duration-500'
            style={{
              background:
                'linear-gradient(135deg, rgba(147, 51, 234, 0.1) 0%, rgba(79, 70, 229, 0.1) 100%)',
            }}
